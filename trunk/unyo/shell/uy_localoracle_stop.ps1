...
# Service STOP
#--------------------------------------------
# ローカルDB(Oracleリスナー)停止処理
#--------------------------------------------
if ( !(FC_SERVICE_MANG ${TG_SVCNAME_LISTENER} STOP) ) {
    ${PRG_EXIT_CODE} = ${DEF_RTNCD_ERR}
    EndProcess
}

#--------------------------------------------
# ローカルDB(Oracleインスタンス)停止処理
#--------------------------------------------
if ( !(FC_SERVICE_MANG ${TG_SVCNAME_ORACLE} STOP) ) {
    ${PRG_EXIT_CODE} = ${DEF_RTNCD_ERR}
    EndProcess
}

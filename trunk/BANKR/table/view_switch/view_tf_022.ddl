...
CREATE OR REPLACE VIEW TF_世帯属性
 ...
 AS SELECT 
    ...
    ,TF_世帯属性B.住所カナ変更フラグ
    ,TF_世帯属性B.自宅電話番号
    ,TF_世帯属性B.自宅電話番号更新フラグ
    ,TF_世帯属性B.自宅FAX番号
    ,TF_世帯属性B.自宅FAX番号更新フラグ
    ,TF_世帯属性B.携帯電話番号
    ,TF_世帯属性B.携帯電話番号更新フラグ
    ,TF_世帯属性B.MAILアドレス
    ,TF_世帯属性B.MAILアドレス更新フラグ
    ,TF_世帯属性B.勤務先名
    ,TF_世帯属性B.勤務先名更新フラグ
    ,TF_世帯属性B.勤務先名カナ
    ,TF_世帯属性B.勤務先名カナ更新フラグ
    ,TF_世帯属性B.勤務先電話番号
    ,TF_世帯属性B.勤務先電話番号更新フラグ
    ,TF_世帯属性B.連絡先住所コード
    ,TF_世帯属性B.連絡先郵便番号
    ,TF_世帯属性B.連絡先補助住所
    ,TF_世帯属性B.連絡先住所変更フラグ
    ,TF_世帯属性B.連絡先補助住所カナ
    ,TF_世帯属性B.連絡先住所カナ変更フラグ
    ,TF_世帯属性B.連絡先電話番号
    ,TF_世帯属性B.連絡先電話番号更新フラグ
    ,TF_世帯属性B.連絡先FAX番号
    ,TF_世帯属性B.連絡先FAX番号更新フラグ
    ,TF_世帯属性B.日中連絡先電話番号
    ,TF_世帯属性B.日中連絡先電話番号更新フラグ
    ,TF_世帯属性B.取引開始日
    ,TF_世帯属性B.世帯主フラグ
    ,TF_世帯属性B.行員区分
    ,TF_世帯属性B.郵便不着
    ...
    ,TF_世帯属性B.ネット支店契約
    ,TF_世帯属性B.ネット支店契約者ID
    ,TF_世帯属性B.ネット支店契約申込店番
    ,TF_世帯属性B.ネット支店契約代表口座科目
    ,TF_世帯属性B.ネット支店契約代表口座口番号
    ,TF_世帯属性B.ネット支店契約日
    ,TF_世帯属性B.ネット支店契約解除日
    ,TF_世帯属性B.ネット支店契約最終更新日
    ,TF_世帯属性B.ホストTM対象区分
    ,TF_世帯属性B.ホストDM対象区分
    ,TF_世帯属性B.TM対象区分
    ,TF_世帯属性B.DM対象区分
    ...
    ,TF_世帯属性B.連絡先住所番地気付
    ,TF_世帯属性B.連絡先住所気付
    ,TF_世帯属性B.連絡先住所都道府県カナ
    ,TF_世帯属性B.連絡先住所市区町村カナ
    ,TF_世帯属性B.連絡先住所大字通称カナ
    ,TF_世帯属性B.連絡先住所字丁目カナ
    ,TF_世帯属性B.連絡先住所番地気付カナ
    ,TF_世帯属性B.連絡先住所気付カナ
    ,TF_世帯属性B.連絡先住所
    ,TF_世帯属性B.連絡先住所カナ
    ,TF_世帯属性B.データ基準日
...
COMMENT ON COLUMN TF_世帯属性.補助住所カナ IS '半角カナ';
...
COMMENT ON COLUMN TF_世帯属性.IB契約者ID IS '12桁固定長';

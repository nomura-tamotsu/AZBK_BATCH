...
Rem Interaction Center サービス停止
echo %date% %time% Interaction Centerサービス停止処理開始 >> %_LOGNAME%
call D:\azbk\unyo\bat\ServiceStop.bat "Interaction Center"
echo %date% %time% Interaction Centerサービス停止処理終了 >> %_LOGNAME%

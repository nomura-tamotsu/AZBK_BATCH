...
Rem ININMediaServer サービス停止
echo %date% %time% ININMediaServer サービス停止処理開始 >> %_LOGNAME%
call D:\azbk\unyo\bat\ServiceStop.bat "ININMediaServer"
echo %date% %time% ININMediaServer サービス停止処理終了 >> %_LOGNAME%

...
Rem IW-CIC_SVC サービス停止
echo %date% %time% IW-CIC_SVC サービス停止処理開始 >> %_LOGNAME%
call D:\azbk\unyo\bat\ServiceStop.bat "IW-CIC_SVC"
echo %date% %time% IW-CIC_SVC サービス停止処理終了 >> %_LOGNAME%

Rem SQLSERVERAGENT サービス停止
echo %date% %time% SQLSERVERAGENT サービス停止処理開始 >> %_LOGNAME%
call D:\azbk\unyo\bat\ServiceStop.bat "SQLSERVERAGENT"
echo %date% %time% SQLSERVERAGENT サービス停止処理終了 >> %_LOGNAME%

Rem MSSQLSERVER サービス停止
echo %date% %time% MSSQLSERVER サービス停止処理開始 >> %_LOGNAME%
call D:\azbk\unyo\bat\ServiceStop.bat "MSSQLSERVER"
echo %date% %time% MSSQLSERVER サービス停止処理終了 >> %_LOGNAME%
